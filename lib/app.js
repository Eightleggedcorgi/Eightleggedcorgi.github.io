...
document.querySelector(".js-fed-button").onclick = function () {
    ...
    alert("Yum yum");
    document.getElementById('image').src="./lib/images/mouthLucy.jpg";
    gatoHunger -= 2; }
    if (gatoHunger < 0) {
        gatoHunger = 0;
    }
...
document.querySelector(".js-rest-button").onclick = function () {
    ...
    alert("Zzzzzz");
    document.getElementById('image').src="./lib/images/sleepLucy.jpg";
    gatoSleep -= 2; }
    if (gatoSleep < 0) {
        gatoSleep = 0;
    }
...
document.querySelector(".js-play-button").onclick = function () {
    ...
    alert("Yippee!");
    document.getElementById('image').src="./lib/images/lobsterLucy.jpg";
    gatoBored -= 1; }
    if (gatoBored < 0) {
        gatoBored = 0;
    }
...
document.querySelector(".js-superres-button").onclick = function () {
    ...
    deathActive = false;
    updateDeathDisplay();
    document.getElementById('image').src="./lib/images/lazyLucy.jpg";
    gatoHunger = 0;
    gatoSleep = 0;
    gatoBored = 0;
    gatoAge = 0;
...
//visual counter operating code
    ...
    function updateDeathDisplay(){
        ...
        document.getElementById('image').src="./lib/images/floppedLucy.jpg";
        }
        else {
